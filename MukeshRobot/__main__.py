...
*๏ sᴀʏᴀ {}
━━━━━━━━━━━━━━━━
sᴀʏᴀ ʀᴏʙᴏᴛ ᴍᴀɴᴀᴊᴇᴍᴇɴ ʙᴇʀᴛᴇᴍᴀ ᴀɴɪᴍᴇ
sɪᴀᴘ ᴍᴇᴍʙᴀɴᴛᴜ ɢʀᴜᴘ ᴀɴᴅᴀ.*
━━━━━━━━━━━━━━━━
   *➻ ᴜsᴇʀs »* {}
   *➻ ᴄʜᴀᴛs »* {}
━━━━━━━━━━━━━━━━
...
HELP_STRINGS = f"""
» *{BOT_NAME}  ᴋʟɪᴋ ᴅᴀғᴛᴀʀ ᴍᴇɴᴜ ᴅɪ ʙᴀᴡᴀʜ ɪɴɪ*"""

DONATE_STRING = f"""@skytrixsz."""
...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(
                            text="🏡 sᴜᴩᴩᴏʀᴛ", url=f"https://t.me/wibuhouse"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(text=" ɪɴғᴏ 🎉", callback_data="donation_help") 
                    ],
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url="https://t.me/skytrixszbot?startgroup=true"
                            )
                       ]
                ]
                     )
